...
+ LLVM IR Language Support by rev.ng Labs
+ LLVM Syntax Highlighting by colejcummings
+ Rewrap by stkb
+ Todo Tree by Gruntfuggly

The LLVM extensions are useful for viewing and editing the LLVM assembly language generated by
AGC. The Rewrap extension is useful for editing comments and documentation to ensure that text
wraps neatly. Use Alt+Q (or Option+Q on macOS) to rewrap a paragraph. The Todo Tree extension is
useful for tracking TODO and FIXME comments in the code.
