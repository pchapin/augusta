...
set CPATH=%HOME%\.ivy2\cache\org.antlr\antlr4\jars\antlr4-4.7.2.jar
set CPATH=%CPATH%;%HOME%\.ivy2\cache\org.antlr\antlr4-runtime\jars\antlr4-runtime-4.7.2.jar
