...
export CPATH=$HOME/.ivy2/cache/org.antlr/antlr4/jars/antlr4-4.13.2.jar
export CPATH=$CPATH:$HOME/.ivy2/cache/org.antlr/antlr4-runtime/jars/antlr4-runtime-4.13.2.jar
