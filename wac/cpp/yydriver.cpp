...
typedef unsigned short  YYACTIONBASETYPE;
typedef unsigned short  YYACTIONTYPE;
typedef unsigned short  YYBITBASETYPE;
typedef unsigned char   YYBITTYPE;
        ...
        yycheck1:
            ...
            yycheck2:
                ...
                case 2:
                    ...
                    while( yysp >= yys ) {
                        yyk = *yysp;
                        while( (yyi  = yyk + YYETOKEN) < 0 ||
                                yyi >= YYUSED              ||
                                yychktab[yyi] != YYETOKEN ) {

                            if( (yyi = yyk + YYPTOKEN) < 0 ||
                                 yyi >= YYUSED             ||
                                 yychktab[yyi] != YYPTOKEN )
                                goto continu;
                            else
                                yyk = yyacttab[yyi];
                        }
